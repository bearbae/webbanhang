...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .columns1, .columns2 {
                width: 50%;
                height: 750px; /* Điều chỉnh chiều cao tùy ý */
                background-color: #F8F8F8;
        ...
        <div class="container2">
            ...
            <div class="content2">
                <div class="full-width" style="font-size: 17px;
                     ...
                     align-items: center;">ACCOUNT DETAILS</div>
                <div class="two-columns">
                    <div class="columns1">
                        ...
                        <form action="change" method = "post">
                            ...
                            <input type="phone" id="phone" name="phone" value="${u.phone}" required><br>

                            <label for="email">EMAIL:</label>
                            <input type="email" id="email" name="email" value="${u.email}" required><br>

                            <label for="firstname">FIRST NAME:</label>
                            <input type="text" id="firstname" name="fname" value="${u.fname}" required><br>

                            <label for="lastname">LAST NAME:</label>
                            <input type="text" id="lastname" name="lname"value="${u.lname}" required><br>
                            ...
                            <p style="font-size: 12px;">You need to be 16 or over to have account with us</p><br>
                    ...
                    <div class="columns2">
                        ...
                        <input type="submit1" value="DOWNLOAD YOUR DATA">

                        <input type="submit2" value="CLOSE ACCOUNT">
                    </div>
                </div>
            </div>
        </div>
