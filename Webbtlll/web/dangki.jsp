                             ...
                             <form action="login" method="post">
                                <div class="content hop1">
                                    ...
                                    <div class="body body-mk">
                                        ...
                                        <p class="error-message" style="padding-bottom: 15px; margin-top: -20px; color: red;font-size: 13px;"><%= request.getAttribute("error") %></p>
											<% } %>	
                                    </div>
            ...
            <form action="register" method="post">
            		 <div class="signup__body-form">
                        <div class="signup__body-phone">
                            ...
                            <input id="sdt" name="phone" type="text" required="yes" class="signup__body-email-input input__text">
                             <% if (request.getAttribute("error2") != null) { %>
                                        <p class="error-message" style="padding-bottom: 15px; color: red;font-size: 13px;"><%= request.getAttribute("error2") %></p>
											<% } %>	
                        </div>
                        ...
                        <div class="signup__body-password">
                            <label for="passwordField" class="signup__body-password-text text--form">Password</label>
                        ...
                        <div class="signup__body-confirm__pw">
                            <label for="cfpasswordField" class="signup__body-confirm__pw-text text--form">Confirm Password</label>
                        ...
                        <div class="signup__form-text text-1">By continuing you agree to our
                            ...
                            <a href="women"> <button type="submit" class="btn--create">Create Acount</button></a>
                    </div>
